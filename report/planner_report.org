...
* Programme Planner
** Introduction
   An idea was investigated as to can a tool be made to help students
   plan their coarse of study for their degree.  This would take the form
   of list of sets of possible papers, with each set being a programme of
   study.
...
** Procedure
   The idea was to take in a list of papers and determine what is the
   best degree and major combination for this selection.  
