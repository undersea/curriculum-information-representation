...
*** Technologies used
**** Python
     Python was chosen to develop this system.  It worked well for
     the Workload application, so it is only logical that Python
     should be used for this application.

     Python also has a easy syntactically pleasing way of creating lists.
     ...
     applying constraints satisfaction to this.
**** Constraints Satisfaction
