...
** jQuery
   The client side javascript was to use the jQuery \cite{jquery1} library.  Using
   jQuery allows the project to overcome and ignore most of the other
   compatibility issues due to the fact that jQuery already deals with
   different versions of javascript in the background.
...
** Redesign phase (following user presentation)
   ...
   edit the teaching allocations and paper coordinations was undertaken.
** Testing
* Implementation
